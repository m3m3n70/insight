...
(function() {
  var InsightFactory, app, mainController, taskListDisplay, taskListEdit;
  ...
  mainController = function($scope, $timeout, $socket, $filter, InsightFactory) {
    var asanaColors, conditionallyAddTask, fireBaseUrl, firebaseRef, generateAllTasks, generateChartForTeam, generateChartsForTeams, generateGraveyardForTeams, generateInitialWowMeter, generateWowMeterForTeams, generateWowTasks, init, initializeTaskRotator, initializeTasks, processCsv, shuffle, updateOnHeartbeat;
    shuffle = function(o) {
      var i, j, x;
      i = o.length;
      while (i) {
    ...
    init = function() {
      ...
      return initializeTasks($scope.riskAreaList);
    };
    init();
